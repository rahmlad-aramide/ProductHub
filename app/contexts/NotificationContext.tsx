...
import { Notification, NotificationContextType, NotificationType } from "../definitions/types";
...
export const NotificationProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const action = (message: string, type: NotificationType, link: string, linkText: string) => {
...
const NotificationComponent: React.FC<NotificationProps> = ({ message, type, link, linkText, autoClose, onClose }) => {
  ...
  const getIcon = (type: Notification["type"]): JSX.Element => {
    switch (type) {
      case "success":
        return (
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#008000" viewBox="0 0 24 24">
      ...
      case "inform":
        return (
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#004085" viewBox="0 0 24 24">
